...
namespace PizzaAppCore.Migrations
{
    ...
    [Migration("20171007160617_DeleteForeignKeyFromExtraingredientsModel")]
    partial class DeleteForeignKeyFromExtraingredientsModel
    {
            ...
            modelBuilder.Entity("PizzaAppCore.Models.PizzaModel", b =>
                {
                    ...
                    b.Property<byte>("ExtraIngredientsModelID");

                    b.Property<int?>("ExtraIngredientsModelID1");
                    ...
                    b.HasIndex("ExtraIngredientsModelID1");
            ...
            modelBuilder.Entity("PizzaAppCore.Models.PizzaModel", b =>
                {
                    b.HasOne("PizzaAppCore.Models.ExtraIngredientsModel", "ExtraIngredientsModel")
                        .WithMany()
                        .HasForeignKey("ExtraIngredientsModelID1");
